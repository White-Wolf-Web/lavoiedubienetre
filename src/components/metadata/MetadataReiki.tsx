export const MetadataReiki = [
	{
	  ...
	  "name": "Séance de Reiki à Trazegnies",
	  "description": "Séance de Reiki à Trazegnies. Découvrez nos soins personnalisés et retrouvez harmonie, bien-être et sérénité dans un cadre apaisant.",
	  "address": {
		"@type": "PostalAddress",
